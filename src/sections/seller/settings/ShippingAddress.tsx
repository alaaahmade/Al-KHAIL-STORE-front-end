...
const ShippingAddress = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      const filteredAddresses = (user?.settings?.shipping_Address || []).filter(
        (a: any) => a.address !== pendingDelete.address
      );
  ...
  return (
    <Box p={3}>
      ...
      <AddAddressDialog open={open} onClose={handleClose} currentAddress={null} />
