    ...
    <Card sx={{ p: 4, borderRadius: 3, boxShadow: 1, mt: 3, px: 15 }}>
      ...
      <Stack spacing={2} mb={3}>
        <Box>
          ...
          <Box sx={{ ml: 2 }}>
            <Typography variant="body2">
              • Free shipping on orders over $50 within the United States
            </Typography>
            <Typography variant="body2">• Standard shipping (5-7 business days)</Typography>
            <Typography variant="body2">
              • Express shipping (2-3 business days) available at additional cost
            </Typography>
            <Typography variant="body2">
        ...
        <Box>
          <Typography fontWeight={600} color="#EC4899" display="flex" alignItems="center" mb={0.5}>
            <Iconify
              icon="pepicons-pencil:arrow-spin"
              width={20}
              height={20}
              style={{ marginRight: 8 }}
            />{' '}
      ...
      <Box sx={{ bgcolor: '#F3F4F6', borderRadius: 2, p: 2, mt: 2 }}>
        ...
        <Typography variant="body2" mb={2}>
          If you have any questions about our policies, please don’t hesitate to contact our
