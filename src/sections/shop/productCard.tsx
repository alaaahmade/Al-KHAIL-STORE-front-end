  ...
  return (
    ...
    >
      <Label
        ...
        sx={{p: '0 1em', borderRadius: 50, right: 10, top: 10, position: 'absolute', zIndex: 2, 
          width: 40,
          height: 40,
        }}
      >
      ...
      sx={{p:'0 1em', m: 0}}
      >
        <Stack direction="row" alignItems="center" justifyContent={'space-between'} spacing={0.5} mt={1}>
          <Typography variant='body2' sx={{color: 'primary.main', }}> {category[0]?.categoryName}</Typography>
