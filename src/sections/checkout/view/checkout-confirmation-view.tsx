...
import { Box, Paper, Typography, Stack, Divider, Avatar, Button } from '@mui/material';
    ...
    <Box sx={{ background: '#f7f8fa', minHeight: '100vh', py: 4 }}>
      <Box sx={{ maxWidth: 800, mx: 'auto', px: 2 }}>
        ...
        <Stack alignItems="center" spacing={2} mb={4}>
          ...
          <Typography variant="h4" sx={{ fontFamily: 'serif', fontWeight: 600 }}>
            Order Confirmed!
          </Typography>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} justifyContent="center" mb={4}>
          <Paper sx={{ p: 2, borderRadius: 2, minWidth: 220, textAlign: 'center' }}>
            <Typography sx={{ fontSize: '0.95em', color: 'text.secondary', fontFamily: 'serif' }}>
              Order Number
            </Typography>
            <Typography sx={{ fontWeight: 600, fontFamily: 'serif' }}>
              {order?.orderNumber}
            </Typography>
          </Paper>
          <Paper sx={{ p: 2, borderRadius: 2, minWidth: 220, textAlign: 'center' }}>
        ...
        <Paper sx={{ p: 3, borderRadius: 3, mb: 3 }}>
              ...
              <Stack direction="row" justifyContent="space-between">
                ...
                <Typography variant="body1" sx={{ fontWeight: 700 }}>
                  {fCurrency(
                    (+order?.cart?.total || 1) +
                      (+tax || 1) +
                      ((+shippingFee || 1) * order?.cart?.items?.length || 1)
                  )}
                </Typography>
              </Stack>
            </Stack>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
            <Paper sx={{ p: 2, borderRadius: 2, flex: 1 }}>
              <Typography sx={{ fontWeight: 500, fontFamily: 'serif', mb: 1 }}>
                Shipping Address
              </Typography>
            ...
            <Paper sx={{ p: 2, borderRadius: 2, flex: 1 }}>
              ...
              <Typography sx={{ fontFamily: 'serif', fontSize: '0.95em', mt: 0.5 }}>
                Expiring {payment.expiry}
              </Typography>
            </Paper>
          </Stack>
        </Paper>
