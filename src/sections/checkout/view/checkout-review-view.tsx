      ...
      <Box sx={{ maxWidth: 1200, mx: 'auto', px: 2 }}>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={3} alignItems="flex-start">
          ...
          <Box flex={2}>
            ...
            <Paper sx={{ mb: 3, p: 3, borderRadius: 3 }}>
              <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                <Box>
                  <Typography
                    variant="subtitle1"
                    sx={{ fontFamily: 'serif', fontWeight: 500, mb: 1 }}
                  >
                    Shipping Address
                  </Typography>
                ...
                >
                  ...
                  <Typography
                    sx={{ color: '#E91E63', fontSize: '0.9em', ml: 0.5, fontFamily: 'serif' }}
                  >
                    Edit
                  </Typography>
                </IconButton>
            ...
            {/* Order Items */}
            <Paper sx={{ mb: 3, p: 3, borderRadius: 3 }}>
              <Typography variant="subtitle1" sx={{ fontFamily: 'serif', fontWeight: 500, mb: 2 }}>
                Order Items
              </Typography>
              <Stack spacing={2}>
                {cart?.items?.length > 0 &&
                  cart?.items?.map((item: any, idx: number) => (
                    <Stack key={idx} direction="row" spacing={2} alignItems="center">
                      ...
                      />
                      <Box>
                        <Typography sx={{ fontSize: '0.95em', fontFamily: 'serif' }}>
                          {item?.product.productName}
                        </Typography>
                        {item?.product?.productSubtitle && (
                          <Typography
                            sx={{ fontSize: '0.8em', color: 'text.secondary', fontFamily: 'serif' }}
                          >
                            {item?.product?.productSubtitle}
                          </Typography>
                        )}
                      ...
                      <Box flex={1} />
                      <Typography sx={{ fontSize: '0.95em', fontFamily: 'serif' }}>
                        {fCurrency(+item?.product?.standardPrice)}
                      </Typography>
                    </Stack>
                  ))}
              </Stack>
            ...
            <Paper sx={{ p: 3, borderRadius: 3 }}>
              <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Typography variant="subtitle1" sx={{ fontFamily: 'serif', fontWeight: 500 }}>
                  Payment Method
                </Typography>
                <IconButton
                  onClick={() => router.push('/checkout/details')}
              ...
              <Stack direction="row" alignItems="center" spacing={1} mt={2}>
                ...
                <Typography sx={{ fontFamily: 'serif', fontSize: '0.95em' }}>
          ...
          <Box flex={1}>
            <Paper sx={{ p: 3, borderRadius: 3, minWidth: 320 }}>
              ...
              <Stack spacing={1} mb={1}>
                ...
                <Stack direction="row" justifyContent="space-between">
                  ...
                  <Typography variant="body2">
                    {fCurrency(+shippingFee * +cart?.items.length)}
                  </Typography>
                </Stack>
                <Stack direction="row" justifyContent="space-between">
              ...
              <Stack direction="row" justifyContent="space-between" sx={{ mb: 2 }}>
                ...
                <Typography variant="body1" sx={{ fontWeight: 700 }}>
                  {fCurrency(+cart?.total + +shippingFee * +cart?.items.length + tax)}
                </Typography>
              </Stack>
              <Button
              ...
              <Typography
                sx={{ fontSize: '0.8em', color: 'text.secondary', textAlign: 'center', mt: 1 }}
              >
                By placing your order, you agree to our{' '}
                <span style={{ color: '#E91E63', textDecoration: 'underline', cursor: 'pointer' }}>
                  Terms of Service
                </span>{' '}
                and{' '}
                <span style={{ color: '#E91E63', textDecoration: 'underline', cursor: 'pointer' }}>
