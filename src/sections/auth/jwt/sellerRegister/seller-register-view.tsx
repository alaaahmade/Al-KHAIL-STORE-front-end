    ...
    >
      ...
      >
        ...
        <Typography fontSize={13} color="#888">
          ...
          <Button
            ...
            variant="text"
            size="small"
            sx={{ color: '#e5487e', minWidth: 0, p: 0, textTransform: 'none' }}
          >
            Sign In
          </Button>
        </Typography>
      ...
      <Box flex={1} display="flex" justifyContent="center" alignItems="center">
        ...
        >
              ...
              {step === 1 && (
                <>
                  ...
                  <TextField
                    ...
                    helperText={step1Errors.phoneNumber}
                  />
                  <TextField
                    label="Password"
                    type="password"
              ...
              {step === 2 && (
                <>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    size="small"
                    error={!!step2Errors.storeName}
                    helperText={step2Errors.storeName}
                  />
                  <TextField
                    label="Description"
                    value={description}
                    ...
                    multiline
                    minRows={3}
                    error={!!step2Errors.description}
                    helperText={step2Errors.description}
                  />
                  <TextField
                    select
                  ...
                  >
                    {categories &&
                      categories.length > 0 &&
                      categories.map((option: { categoryName: string; id: number }) => (
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography fontSize={13}>
                        I agree to the{' '}
                        <span style={{ color: '#e5487e', cursor: 'pointer' }}>
                          Terms of Service
                        </span>{' '}
                        and{' '}
                        <span style={{ color: '#e5487e', cursor: 'pointer' }}>Privacy Policy</span>
                      </Typography>
                    }
                  ...
                  <Box display="flex" gap={2} mt={2}>
                    <Button
                      variant="outlined"
                      fullWidth
                      sx={{ borderColor: '#e5487e', color: '#e5487e', textTransform: 'none' }}
                      onClick={() => setStep(1)}
                    >
                      Back
                    </Button>
          ...
          >
            <Box>
              <Typography variant="h6" fontFamily="inherit" fontWeight={500} mb={2}>
                Why Sell on AL KHAIL
              </Typography>
              <Box display="flex" alignItems="flex-start" mb={2}>
                ...
                <Box>
                  ...
                  <Typography fontSize={13} color="#f1e3f7">
                    Reach millions of beauty enthusiasts looking for quality products
                  </Typography>
                </Box>
              </Box>
              <Box display="flex" alignItems="flex-start" mb={2}>
              ...
              <Box display="flex" alignItems="flex-start" mb={3}>
                ...
                <Box>
                  ...
                  <Typography fontSize={13} color="#f1e3f7">
                    Safe and reliable platform for your business operations
                  </Typography>
                </Box>
              </Box>
            </Box>
            ...
            >
              ...
              <Box>
                <Typography fontWeight={500} fontSize={15} color="#fff">
                  Emma Thompson
                </Typography>
                <Typography fontSize={13} color="#f1e3f7">
                  Verified Seller
                ...
                <Typography fontSize={13} color="#fff" mt={1} fontStyle="italic">
                  "Starting my beauty brand on AL KHAIL was the best decision. The support and tools
                  provided helped me scale my business rapidly."
                </Typography>
              </Box>
            </Box>
          </Box>
      ...
      <Box py={3} borderTop="1px solid #eee" textAlign="center" fontSize={13} color="#888">
        ...
        <Box>
          <Button
            ...
            variant="text"
            size="small"
            sx={{ color: '#888', minWidth: 0, p: 0, textTransform: 'none' }}
          >
            Privacy Policy
          </Button>
