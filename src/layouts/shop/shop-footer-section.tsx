  ...
  <Box sx={{ background: '#181B23', color: '#fff', py: 6, mt: 0, px: 12 }}>
    <Grid container spacing={4} sx={{py: 4, borderBottom: '2px solid #333'}}>
      <Grid item xs={12} md={3}>
        <Typography fontWeight={700} mb={2}>AL KHAIL STORE</Typography>
        <Typography variant="body2" color="rgba(156, 163, 175, 1)">Your trusted destination for beauty products.</Typography>
        <Stack direction="row" spacing={1} mt={2}>
          <IconButton >
            <Iconify color="rgba(156, 163, 175, 1)" icon="ic:baseline-facebook" width="24" height="24" />
          </IconButton>
          <IconButton >
            <Iconify color="rgba(156, 163, 175, 1)" icon="mdi:instagram" width="24" height="24" />            </IconButton>
          <IconButton >
      ...
      <Grid item xs={12} md={3}>
        <Typography fontWeight={700} mb={2}>Newsletter</Typography>
          <Typography variant="body2" color="rgba(156, 163, 175, 1)">Subscribe to get special offers and updates</Typography>
